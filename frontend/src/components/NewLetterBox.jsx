  ...
  return (
    <section ref={sectionRef} className="w-full min-h-screen px-4 py-16 md:py-24 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-4xl w-full relative z-10">
        <div
          className={`bg-gradient-to-br from-white/95 to-gray-50/95 dark:from-gray-900/95 dark:to-gray-800/95 rounded-3xl overflow-hidden border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-sm
            shadow-2xl transition-all duration-700 ${isHovered ? 'shadow-cyan-500/20 border-gray-300/70 dark:border-gray-600/70 scale-[1.01]' : ''}`}
        ...
        >
          ...
          <div className="relative bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 py-10 px-6 text-center overflow-hidden">
            ...
            <div className="flex flex-col items-center relative">
              ...
              <h2 className="text-2xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3 drop-shadow-lg">
                ...
                {features.map((feature, index) => (
                  <div key={index} className="newsletter-feature group flex items-start gap-4 p-3 rounded-xl transition-all duration-300 hover:bg-white/5 cursor-pointer">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 dark:text-gray-400 text-sm mt-1 group-hover:text-gray-300 transition-colors duration-300">{feature.description}</p>
                    </div>
                  </div>
                ))}
