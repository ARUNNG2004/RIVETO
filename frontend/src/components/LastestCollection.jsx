...
function LatestCollection() {
  ...
  return (
    <div ref={sectionRef} className="w-full min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-[#0a0a0f] dark:via-[#0f1117] dark:to-[#06080e] py-16 px-4 md:px-7 relative overflow-hidden">
      ...
      <div className="text-center mb-12 z-10 relative">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-3 text-lg md:text-xl font-light max-w-2xl mx-auto">
