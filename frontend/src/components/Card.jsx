...
function Card({ name, image, id, price, showQuickActions = true, badge, badgeColor = "from-blue-500 to-cyan-500", onCompare, isCompared }) {
  ...
  return (
    <div
      ref={cardRef}
      className="relative bg-white dark:bg-gradient-to-br dark:from-gray-900/90 dark:to-gray-800/90 rounded-2xl overflow-hidden shadow-xl cursor-pointer group border border-gray-200 dark:border-gray-700/50 backdrop-blur-sm"
    ...
    >
      ...
      <div className="relative overflow-hidden">
        ...
        {!imageLoaded && !imageError && (
          <div className="w-full h-64 bg-gradient-to-br from-gray-200 to-gray-100 dark:from-gray-800 dark:to-gray-700 animate-pulse">
        ...
        <div className="flex items-center gap-2 mb-3">
          <div className="flex items-center gap-1">
            {[...Array(5)].map((_, i) => (
              <FaStar
                key={i}
                className={`text-sm transition-all duration-300 ${i < Math.floor(rating) ? 'text-yellow-400 drop-shadow-[0_0_3px_rgba(250,204,21,0.5)]' : 'text-gray-300 dark:text-gray-600'
                  }`}
                style={{
            ...
            <span className="text-gray-900 dark:text-white text-sm font-medium ml-1">{rating}</span>
          </div>
